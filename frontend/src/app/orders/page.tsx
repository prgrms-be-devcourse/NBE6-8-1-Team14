...
export default function OrderHistory() {
    const { error, loading, orders, cancelOrder, orderCanceled, detailRequestUrl } = useOrders();
        ...
        return (
            <div className="flex flex-col justify-center items-center min-h-screen gap-4">
                ...
                )}
                {
                    error && (
                        <>
                            <IoWarningOutline className="w-16 h-16 text-gray-600" />
                            <span className="text-lg text-gray-700">이런! 뭔가 잘못됐어요!</span>
                        </>
                    )
                }
